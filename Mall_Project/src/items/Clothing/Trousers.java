...
public class Trousers extends ClothingWithSize implements IsReturnable{
	
	public Trousers(String itemName, double itemPrice, double itemDiscount, int itemQuantity, String color, Object size) {
